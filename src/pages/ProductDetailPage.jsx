  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <button
        ...
        className="flex items-center text-blue-600 hover:text-red-700 mb-6 cursor-pointer transition-colors"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <button
            ...
            className="w-full bg-blue-600 hover:bg-red-700 text-white py-3 px-6 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 cursor-pointer"
          >
